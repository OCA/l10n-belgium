...
class AccountStatementImport(models.TransientModel):
    ...
    def _parse_file(self, data_file):
        ...
        try:
            ...
            for statement in statements:
                vals_statements.append(self.get_st_vals(statement))
        ...
        return currency, self._get_acc_number(acc_number), vals_statements
    ...
    def get_st_line_payment_ref(self, line, globalisation_dict):
        """
        ...
        '/'
        """
        payment_ref = line.communication
        if not payment_ref and line.ref_move in globalisation_dict:
            payment_ref = globalisation_dict[line.ref_move].communication
        return payment_ref or "/"
    ...
    def get_st_line_vals(self, line, globalisation_dict, information_dict):
        ...
        if line.transaction_amount_sign == AmountSign.DEBIT:
            amount = -amount
        return {
            "payment_ref": self.get_st_line_payment_ref(line, globalisation_dict),
