...
def set_unece_on_taxes(cr, registry):
    f = file_open("l10n_be_account_tax_unece/data/account_tax_template.xml", "rb")
    ...
    with api.Environment.manage():
        ...
        for company in companies:
            ...
            if company.country_id and company.country_id != env.ref("base.be"):
                continue
            ...
            for tax in taxes:
                ...
                if xmlid_obj and xmlid_obj.name and len(xmlid_obj.name.split("_")) > 1:
                    ...
                    xmlid_ori = "l10n_be.%s" % xmlid_ori_end
