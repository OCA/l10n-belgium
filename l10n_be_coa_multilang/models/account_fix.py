...
class AccountAccount(models.Model):
    ...
    def _check_account_type(self, cr, uid, ids, context=None):
        """
        Remove the standard constraint that makes impossible to use balance for receivable - payable
        This fix should be generic - not a Belgian problem
        Should be in account-financial-tools/account_constraints
